...
@Component({
    ...
    imports: [ServiciosComponent, Servicios2Component, NosotrosComponent, FooterComponent, GaleriaComponent, BlogComponent, RouterLink, NavResponsiveComponent, Subservicios1Component, Subservicios3Component, Subservicios7Component, Subservicios2Component, Subservicios4Component, Subservicios5Component, Subservicios6Component, WhatsappComponent, BuscadorComponent]
})
